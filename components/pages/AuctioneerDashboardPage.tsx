...
const ReportSection: React.FC<{
  ...
  >
    <option value="" style={{ background: '#2b0a12', color: '#fff' }}>
      All Teams
    </option>
    ...
    {teams.map(t => (
      <option
        key={t.id}
        value={t.id}
        style={{ background: '#2b0a12', color: '#fff' }}
      >
        {t.name}
      </option>
    ))}
  ...
  <Filter
    size={14}
    className="absolute right-3 top-1/2 -translate-y-1/2 text-pink-400/50 pointer-events-none"
  />
</div>
...
<div className="relative">
  ...
  >
    <option value="all" style={{ background: '#2b0a12', color: '#fff' }}>
      All Status
    </option>

    <option value="sold" style={{ background: '#2b0a12', color: '#fff' }}>
      Sold
    </option>

    <option value="unsold" style={{ background: '#2b0a12', color: '#fff' }}>
      Unsold
    </option>

    <option value="available" style={{ background: '#2b0a12', color: '#fff' }}>
      Available
    </option>

    {isLive && (
      <option value="live" style={{ background: '#2b0a12', color: '#fff' }}>
        Live (Bidding)
      </option>
    )}
  </select>
